Rails.application.routes.draw do
  ...
  post'/applications/:password_reset_token/chats/:chat_number', to: 'chats#create'
  get '/applications/:password_reset_token/chats/:chat_number' ,to:'chats#get'


  post'/applications/:password_reset_token/chats/:chat_number/messages/:message_number/:message', to: 'messages#create'
